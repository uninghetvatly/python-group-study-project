...
t1 = tuple([1,2,3,'a','b','c'])
print(t1)

#Creating tuple with one item
tup = (10, ) # Comma is needed so that compiler wont confuse with int type
print(tup)
...
# Printing elements of a Range (excluding end)
print(t1[2:5])

#Can only delete an entire tuple, not separate item
del t
...
#Finding length using len(<tuple>)
print(len(t1))

#Convert a list into a tuple using tuple(<list>)
t=tuple(l1)
print(t)
